...
//   const { user, isAuthenticated, loading } = useSession();
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle className="text-center font-semibold">Log Activity</DialogTitle>
          <DialogDescription className="text-center font-semibold">Record your wellness activity</DialogDescription>
        </DialogHeader>
